...
corr_figures.dir <- paste0("results/", Sys.Date(), "/", "corr_figures/")

## creates result.dir with date in if not existent
ifelse(isFALSE(dir.exists(paste0("../",result.dir))), dir.create(paste0("../",result.dir),recursive = TRUE),"Result directory for today exists already!")

ifelse(isFALSE(dir.exists(paste0("../", corr_figures.dir))),
  dir.create(paste0("../", corr_figures.dir), recursive = TRUE),
...
#transcript_data_tpm <- data.table::fread("../data/machine_learning_dataset/TPM_fold_changes_correlation_psdc.csv") 
transcript_data_tpm <- data.table::fread("../data/machine_learning_dataset/TPM_fold_changes_correlation_protein_coding.csv") 

transcript_data <- transcript_data_tpm

#cxcl10_data <- dplyr::filter(transcript_data, grepl('CXCL10',rownames(transcript_data)))
...
deg_list_d1 <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Dose 1 0-24 hours.csv") 
deg_list_d2 <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Dose 2 0-24 hours.csv") 
deg_list_d3 <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Dose 3 0-24 hours.csv")
...
deg_list_d1_exp <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Conv Dose 1 0-24 hours.csv")
deg_list_d2_exp <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Conv Dose 2 0-24 hours.csv")
deg_list_d3_exp <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Conv Dose 3 0-24 hours.csv")
deg_list_d1_nai <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Naïve Dose 1 0-24 hours.csv")
deg_list_d2_nai <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Naïve Dose 2 0-24 hours.csv")
deg_list_d3_nai <- data.table::fread("../data/machine_learning_dataset/protein_coding_degs/Naïve Dose 3 0-24 hours.csv")
...
#Testing if removing the 1's & NAs first affects the correlation heat maps
...
#Removing all 1s from cytokine data

#Removing NAs and all 1's
cyto_spear_d1 <- not_all_ones(cyto_spear_d1)
cyto_spear_d1 <- as.data.frame(cyto_spear_d1) %>% select(where(not_all_na))




#Removing NAs subject 21
d2_spear <- na.omit(d2_spear)

#Removing NAs and all 1's
cyto_spear_d2 <- not_all_ones(cyto_spear_d2)
cyto_spear_d2 <- as.data.frame(cyto_spear_d2) %>% select(where(not_all_na))

#removing subject 21
cyto_spear_d2 <- cyto_spear_d2[-8,] 
  

#Removing NAs subject 21, 15, 2
d3_spear <- na.omit(d3_spear)

#Removing NAs and all 1's
cyto_spear_d3 <- as.data.frame(cyto_spear_d3) %>% select(where(not_all_na))

#removing subject 21, 15, 2
cyto_spear_d3 <- cyto_spear_d3[-c(4,7:8),] 
cyto_spear_d3 <- not_all_ones(cyto_spear_d3)
...
spearman_deg <- corr.test(d1_spear, cyto_spear_d1, method ="spearman", adjust ="fdr")
hist(spearman_deg$p)
...
spearman_deg2 <- corr.test(cyto_spear_d2, d2_spear,  method ="spearman", adjust ="fdr", ci = FALSE)
...
spearman_deg3 <- corr.test(cyto_spear_d3, d3_spear,  method ="spearman", adjust ="fdr", ci = FALSE)
#Generates list of p-values for each gene correlated with the proteins
...
corrplot(filtered_r_value_matrix, insig = 'blank')

#Saving plots
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_pc_degs.pdf"),  width = 25, height = 25)
  corrplot(filtered_r_value_matrix)
  dev.off()
}
...
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_sigX_pcdegs.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg2$r, p.mat = spearman_deg2$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
...
#corrplot(spearman_deg3$r) # code breaks!
corrplot(filtered_r_value_matrix3)

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3.pdf"),  width = 25, height = 25)
  corrplot(filtered_r_value_matrix3)
  dev.off()
}

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3_sigX.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg3$r, p.mat = spearman_deg3$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
...
## Correlation tests by group: experienced or naive data pre-processing
```{r}
...
#Removing NAs & missing values: Patient 21 from dose 2 & 2, 15, & 21 from dose 3
d2_spears_exp <- na.omit(d2_spears_exp)

d3_spears_exp <- na.omit(d3_spears_exp)

d3_spears_nai <- na.omit(d3_spears_nai)
...
cyto_spearsd1_exp <- not_all_ones(cyto_spearsd1_exp)
cyto_spearsd1_exp <- as.data.frame(cyto_spearsd1_exp) %>% select(where(not_all_na))
...
cyto_spearsd1_nai <-  not_all_ones(cyto_spearsd1_nai)
...
#Removing all 1s and NAs
cyto_spearsd2_exp <-  not_all_ones(cyto_spearsd2_exp)
cyto_spearsd2_exp <- as.data.frame(cyto_spearsd2_exp) %>% select(where(not_all_na))
#removing patient 21
cyto_spearsd2_exp <- cyto_spearsd2_exp[-4,] 
...
#Removing all 1s and NAs
cyto_spearsd2_nai <-  not_all_ones(cyto_spearsd2_nai)
cyto_spearsd2_nai <- as.data.frame(cyto_spearsd2_nai) %>% select(where(not_all_na))
...
#Removing all 1s and NAs
cyto_spearsd3_exp <-  not_all_ones(cyto_spearsd3_exp)
cyto_spearsd3_exp <- as.data.frame(cyto_spearsd3_exp) %>% select(where(not_all_na))

#removing patient 21
cyto_spearsd3_exp <- cyto_spearsd3_exp[-4,] 
...
#removing patient 2 & 15
cyto_spearsd3_nai <- cyto_spearsd3_nai[-c(3:4),] 

#Removing all 1s and NAs
cyto_spearsd3_nai <-  not_all_ones(cyto_spearsd3_nai)
cyto_spearsd3_nai <- as.data.frame(cyto_spearsd3_nai) %>% select(where(not_all_na))
...
spearman_deg1_exp <- corr.test(cyto_spearsd1_exp, d1_spears_exp,  method ="spearman", adjust ="fdr", ci = FALSE)
#Generates list of p-values for each gene correlated with the proteins
...
spearman_deg2_exp <- corr.test(cyto_spearsd2_exp, d2_spears_exp,  method ="spearman", adjust ="fdr", ci = FALSE)
#Generates list of p-values for each gene correlated with the proteins
...
#Spearman correlation test transcripts and cytokines after DEG filter: D2-
spearman_deg2_nai <- corr.test( cyto_spearsd2_nai, d2_spears_nai, method ="spearman", adjust ="fdr", ci = FALSE)
#Generates list of p-values for each gene correlated with the proteins
deg_sig_values2_nai <- spearman_deg2_nai$p.adj
#list of logical values 
...
spearman_deg3_exp <- corr.test( cyto_spearsd3_exp, d3_spears_exp, method ="spearman", adjust ="fdr", ci = FALSE)
#Generates list of p-values for each gene correlated with the proteins
...
#Spearman correlation test transcripts and cytokines after DEG filter: D3-
spearman_deg3_nai <- corr.test( cyto_spearsd3_nai, d3_spears_nai, method ="spearman", adjust ="fdr", ci = FALSE)
#Generates list of p-values for each gene correlated with the proteins
...
corrplot(filtered_r_value_matrix_exp1 )

corrplot(spearman_deg1_exp$r, p.mat = spearman_deg1_exp$p.adj, sig.level = 0.05,  tl.cex = 0.5, insig ='blank'  )

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose1_exp.pdf"),  width = 25, height = 25)
  corrplot(filtered_r_value_matrix_exp1)
  dev.off()
}

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose1_exp_insigblank.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg1_exp$r, p.mat = spearman_deg1_exp$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
...
#columns
selected_cols_exp2 <- apply(deg_sig_list2_exp, 2, any)

# Filter both matrices based on selected rows, removing NAs
filtered_r_value_matrix_exp2 <- spearman_deg2_exp$r[selected_rows_exp2,selected_cols_exp2 ]
filtered_p_value_matrix_exp2 <- spearman_deg2_exp$p.adj[selected_rows_exp2,selected_cols_exp2 ]
...
corrplot(filtered_r_value_matrix_exp2, p.mat = filtered_p_value_matrix_exp2, sig.level =  0.05, tl.cex = 0.4, 
           insig ='label_sig',)

corrplot(spearman_deg2_exp$r, p.mat = spearman_deg2_exp$p.adj, sig.level = 0.05,  tl.cex = 0.5, insig ='blank'  )

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_exp_significant.pdf"),  width = 8, height = 8)
  corrplot(filtered_r_value_matrix_exp2, p.mat = filtered_p_value_matrix_exp2, sig.level =  0.05, tl.cex = 0.4, 
           insig ='label_sig',)
  dev.off()
}
...
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_exp_sig.pdf"),  width = 75, height = 75)
  corrplot(spearman_deg2_exp$r, p.mat = spearman_deg2_exp$p.adj, sig.level = 0.05, tl.cex = 0.4, #sig.level = c(0.001, 0.01, 0.05),
           insig ='label_sig',
         )
  dev.off()
}
...
selected_cols_nai2 <- apply(deg_sig_list2_nai, 2, any)

# Filter both matrices based on selected rows, removing NAs
filtered_r_value_matrix_nai2 <- spearman_deg2_nai$r[selected_rows_nai2,selected_cols_nai2 ]
filtered_p_value_matrix_nai2 <- spearman_deg2_nai$p.adj[selected_rows_nai2,selected_cols_nai2 ]
#filtered_r_value_matrix_nai2<- as.data.frame(filtered_r_value_matrix_nai2)



# Example: Select rows with the 20 lowest p-values
#selected_rows_nai2 <- head(order(apply(deg_sig_values2_nai, 1, min)), 20)
# Example: Select columns with the 20 lowest p-values
selected_cols_nai2 <- head(order(apply(deg_sig_values2_nai, 2, min)), 20)
...
corrplot(filtered_r_value_matrix_nai2)

corrplot(spearman_deg2_nai$r, p.mat = spearman_deg2_nai$p.adj, sig.level = 0.05,  tl.cex = 0.5, insig ='blank'  )

corrplot(filtered_r_value_matrix_nai2, p.mat = filtered_p_value_matrix_nai2, sig.level =  0.05, tl.cex = 1, 
           insig ='label_sig',)

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_naive_significant_top20.pdf"),  width = 10, height = 10)
  corrplot(filtered_r_value_matrix_nai2, p.mat = filtered_p_value_matrix_nai2, sig.level =  0.05, tl.cex = .8, 
           insig ='label_sig',)
...
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_nai_insigblank.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg2_nai$r, p.mat = spearman_deg2_nai$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
...
# Filter both matrices based on selected rows, removing NAs
filtered_r_value_matrix_exp3 <- spearman_deg3_exp$r[selected_rows_exp3, ] #Only one protein correlation is significant so we lose the rows
...
#Plots
#r_matrix_filtered_exp3 <- filtered_r_matrix_exp3
#corrplot(filtered_r_value_matrix_exp3)

corrplot(spearman_deg3_exp$r, p.mat = spearman_deg3_exp$p.adj, sig.level = 0.05,  tl.cex = 0.5, insig ='blank'  )
...
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3_exp_insigblank.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg3_exp$r, p.mat = spearman_deg3_exp$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
...
corrplot(filtered_r_value_matrix_nai3)

corrplot(spearman_deg3_nai$r, p.mat = spearman_deg3_nai$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank' )

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3_naive.pdf"),  width = 25, height = 25)
  corrplot(filtered_r_value_matrix_nai3)
  dev.off()
}

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3_nai_insigblank.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg3_nai$r, p.mat = spearman_deg3_nai$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
...
#Visualising insig values 

# {
#   pdf(paste0("../",result.dir,"spearman_dose1_naive_x.pdf"),  width = 25, height = 25)
#   corrplot(spearman_deg1_nai$r, p.mat = spearman_deg1_nai$p.adj, sig.level = 0.05, tl.cex = 1, insig ='blank',
#          )
#   dev.off()
# }

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose1_exp_x.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg1_exp$r, p.mat = spearman_deg1_exp$p.adj, sig.level = 0.05, tl.cex = 1, insig ='blank',
         )
  dev.off()
}
...
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_naive_x.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg2_nai$r, p.mat = spearman_deg2_nai$p.adj, sig.level = 0.05, tl.cex = .3, insig ='blank',
         )
  dev.off()
}
...
{
  pdf(paste0("../",corr_figures.dir,"spearman_dose2_exp_x.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg2_exp$r, p.mat = spearman_deg2_exp$p.adj, sig.level = 0.05, tl.cex = 0.3, insig ='blank',
         )
  dev.off()
}

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3_naive_x.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg3_nai$r, p.mat = spearman_deg3_nai$p.adj, sig.level = 0.05, tl.cex = .8, insig ='blank',
         )
  dev.off()
}

{
  pdf(paste0("../",corr_figures.dir,"spearman_dose3_exp_x.pdf"),  width = 25, height = 25)
  corrplot(spearman_deg3_exp$r, p.mat = spearman_deg3_exp$p.adj, sig.level = 0.05, tl.cex = 0.5, insig ='blank',
         )
  dev.off()
}
