...
Gene set enrichment analysis based on fold change ranking using the blood transcriptome modules presented in [Li et al. 2014](10.1038/ni.2789). Cut-off for both analysis was FDR-adjusted p-value < 0.05. N = 15
...
Genes differentially upregulated in response to mRNA vaccination are enriched for antiviral and proinflammatory signaling pathways.

DEGs with log2(fold change) greater than 1. 
Cut-off for DEGs was FDR-adjusted p-value < 0.05. 
N = 15.
...
### Figure 3 B MSigDB subset
Over-representation analysis of DEGs with log2(fold change) greater than 1 using the MSigDB subset of Transcriptional Factor Targets.
...
### Figure 3A KEGG Pathway database
Over-representation analysis of DEGs with log2(fold change) greater than 1 using KEGG Pathway database.
