...
Plotting raw counts for first visual inspection. Boxplot shows median values zero across all samples. 
In histogram there is a huge peak of zeros. Both indicate that the data set would benefit from a low count filtering.
...
Generating three separte DESeq objects with different design parameters to allow for more comparisons. 
...
hist(vst_matrix)
boxplot(vst_matrix, ylab = expression("Log"[2] ~ "Read counts"), 
        las = 2, 
        main = "VST")
```
...
{
  pdf(paste0("../", figures.dir, "heatmap.pdf"), 
      width = 10, height = 8, compress = TRUE)
...
{
  pdf(paste0("../", figures.dir, "PCA.pdf"), 
      width = 10, height = 8, compress = TRUE)
