...
ggsave(
  filename = paste0("../", result.dir, "ora_kegg_pathway_network.pdf"),
  height = 10, width = 10
)

compared_cluster_cnet <- setReadable(compared_cluster, OrgDb = org.Hs.eg.db, "ENTREZID")
cnetplot(compared_cluster_cnet, showCategory = c(
...
ggsave(
  filename = paste0("../", result.dir, "ora_kegg_pathway_gene_network_selected.pdf"),
  height = 10, width = 10
)
...
ggsave(
  filename = paste0("../", result.dir, "ora_kegg_pathway_dotplot.pdf"),
  height = 15, width = 15
)
```
