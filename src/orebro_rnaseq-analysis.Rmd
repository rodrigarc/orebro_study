...
volcano_plot <-  function(x){
  ...
  label.list <- c("RSAD2", "IFIT1", "CXCL10", "CMPK2", "GBP1P1", "IFI44L", "BATF2", "SIGLEC1", "IFI44", "NDUFS4", "MX1", "CXCL9", "FCGR1A", "FCGR1B", "CCL4")
  label<- subsetted %>% filter(gene_symbol %in% label.list)
