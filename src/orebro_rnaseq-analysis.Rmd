...
Database for enrichment analysis, "Reactome".
...
The Jaccard index is a measure of similarity between two sets of genes. Calculated using the GeneOverlap package.
