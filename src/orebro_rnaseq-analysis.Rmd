...
Plotting raw counts for first visual inspection. Boxplot shows median values zero across all samples. In histogram there is a huge peak of zeros. Both indicate that the data set would benefit from a low count filtering.
...
Generating three separte DESeq objects with different design parameters to allow for more comparisons. Controlling for age and sex.
...
sel_list_gse <- list_gse[c("Naïve Dose 1 0-24 hours", 
                           "Naïve Dose 2 0-24 hours", 
                           "Naïve Dose 3 0-24 hours", 
                           "Naïve Dose 3 0-48 hours", 
                           "Conv Dose 1 0-24 hours", 
...
col_order <- c("Naïve Dose 1 0-24 hours", 
                "Conv Dose 1 0-24 hours", 
               "Naïve Dose 2 0-24 hours", 
                "Conv Dose 2 0-24 hours", 
               "Naïve Dose 3 0-24 hours", 
