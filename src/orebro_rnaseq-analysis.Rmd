...
original_gene_list <- res_pos$log2FoldChange
# name the vector
names(original_gene_list) <- rownames(res_pos)
# omit any NA values 
...
dme <- pathview(gene.data=kegg_gene_list, pathway.id="hsa04620", species = kegg_organism, kegg.native = F)
```
```{r pressure, echo=TRUE, fig.cap="KEGG Native Enriched Pathway Plot", out.width = '100%'}
knitr::include_graphics("hsa04620.pathview.png")
```
