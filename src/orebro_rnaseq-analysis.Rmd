...
#merge dataframes
counts_raw <- merge(counts_raw_1, counts_raw_3, by=c("gene_name"))
...
colnames <- as.data.frame(colnames(counts_raw_3))
...
# save vendiagram
   ggsave(
      filename = paste0("../", figures.dir,"ggvendiagram_dose.pdf"),
      height = 7, width = 7)
